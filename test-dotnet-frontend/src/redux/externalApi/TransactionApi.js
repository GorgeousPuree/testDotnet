...
export const TransactionApi = {
	addImportedTransactions: (csv) =>
		axios.post(transactionUrl + 'import', csv, {
			headers: { 'Content-Type': 'multipart/form-data' },
		}),

	getExportedTransactions: (filters) =>
		axios.get(transactionUrl + 'export', {
			params: {
	...
	getTransactionsCount: (filters) =>
		axios.get(transactionUrl + 'count', {
			params: {
				statuses: filters.transactionStatusesFilter,
				types: filters.transactionTypesFilter,
			},
